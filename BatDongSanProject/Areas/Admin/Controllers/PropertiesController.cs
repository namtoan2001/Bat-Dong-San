...
using BatDongSanProject.Models;

namespace BatDongSanProject.Areas.Admin.Controllers
{
    public class PropertiesController : Controller
    {
        private AD25Team25Entities1 db = new AD25Team25Entities1();
        ...
        {
            var link = from l in db.Properties
                       select l;
            if (!String.IsNullOrEmpty(search))
            {
                link = link.Where(s => s.Property_Name.Contains(search));
            }
            return View(link);
        }
