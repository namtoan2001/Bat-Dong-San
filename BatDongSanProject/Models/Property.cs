...
namespace BatDongSanProject.Models
{
    using System;
    ...
    public partial class Property
    {
        ...
        [Range(1,500,ErrorMessage = "Giá trị nhập từ 1-500")]
        public Nullable<int> Area { get; set; }
        [Required(ErrorMessage = "Vui lòng nhập số phòng ngủ")]
        [Range(1,50,ErrorMessage = "Giá trị nhập từ 1-50")]
        public Nullable<int> Bed_Room { get; set; }
        [Required(ErrorMessage = "Vui lòng nhập số phòng tắm")]
        [Range(1,50,ErrorMessage = "Giá trị nhập từ 1-50")]
        public Nullable<int> Bath_Room { get; set; }
        [Required(ErrorMessage = "Vui lòng nhập giá")]
        [Range(0,99999999999, ErrorMessage = "Giá trị nhập không hợp lệ")]
        public Nullable<decimal> Price { get; set; }
        [Required(ErrorMessage = "Vui lòng nhập tỷ lệ trả góp")]
        [Range(0,100)]
